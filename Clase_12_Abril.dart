...
class Uni {
  ...
  // FACTORY CONSTRUCTOR, NOS AYUDA A CREAR UNA INSTANCIA DE NUESTRA CLASE
  factory Uni.test(Map<String, dynamic> json) =>
      Uni(name: json['name'], ubicacion: json['ubicacion']);
}
